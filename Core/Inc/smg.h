...
#define TM1640_CLK_SetHigh()            HAL_GPIO_WritePin(TM1640_GPIO,TM1640_CLK,GPIO_PIN_SET)    // 输出高电平
#define TM1640_CLK_SetLow()             HAL_GPIO_WritePin(TM1640_GPIO,TM1640_CLK,GPIO_PIN_RESET)  // 输出低电平

#define TM1640_DIN_SetHigh()            HAL_GPIO_WritePin(TM1640_GPIO,TM1640_DIN,GPIO_PIN_SET)    // 输出高电平
